...
<div class="login-card">
    ...
    <form action="auth.php" method="POST">
        <div class="input-group">
            ...
            <!-- CAMBIO: placeholder actualizado para DNI o correo -->
            <input type="text" name="usuario" placeholder="Correo electrónico o DNI" required>
        </div>
    ...
    <?php if(isset($_GET['error'])): ?>
        <div class="error">
            ...
            <span>
                <?php 
                    if($_GET['error']==1) echo "Credenciales incorrectas.";
                    if($_GET['error']==2) echo "Acceso pendiente de aprobación.";
                ?>
            </span>
        </div>
    <?php endif; ?>
